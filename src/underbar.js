(function() {
  ...
  _.invoke = function(collection, functionOrKey, args) {
        ...
        var newCollection = [];
          ...
          newCollection = _.map(collection, function(element) {
            if (!!element[functionOrKey]) {
              return element[functionOrKey].apply(element);
            }
            else {
  ...
  _.intersection = function() {
    ...
    _.each(argZero, function (zeroElement) {
      ...
      if (_.every(arrays, function(arg, index, list) {
        return _.contains(arg, zeroElement);
